    ...
    <div className="mb-4 sm:px-20 px-5 sm:pt-20 pt-72 flex flex-col gap-10 overflow-hidden">
      <div className="bg-black/30 text-white  rounded-lg grid md:grid-cols-2 gap-10 relative">
        <div className="flex flex-col gap-8 p-8 md:w-10/12">
          ...
          <p className="text-primary lg:absolute text-6xl font-coolvetica left-[39%] flex flex-col gap-1">
            <span className="lg:text-[30rem]">15</span>
            <span className="lg:-mt-12 lg:ml-16 text-5xl">years</span>
          </p>
