  ...
  return (
    <nav className="w-full">
      <div className=" flex  justify-between  gap-1 px-10 py-5">
        ...
        <ul className="md:flex hidden gap-5 capitalize font-medium text-sm">
          <li>
        ...
        <div className="relative flex gap-2">
          ...
          <div className="bg-primary h-5 w-5 flex justify-center items-center text-xs rounded-sm text-darkgrey">
            2
          </div>
